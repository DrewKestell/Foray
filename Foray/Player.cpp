	...
	ID3D11Device* device)
{
	...
	// create sprite
	XMFLOAT3 pos{ 150.0f, 740.0f, 0.0f };
	...
	sprite = std::make_unique<Sprite>(vertexShader, pixelShader, texture.Get(), vertexShaderBuffer, vertexShaderSize, device, vec.x, vec.y, 200.0f, 200.0f, 3);
}
